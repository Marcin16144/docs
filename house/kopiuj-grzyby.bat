...
echo.
echo  ============================================
echo   Kopiowanie Przewodnika Grzybowego
echo  ============================================
echo.

if not exist "!SRC!\" (
    echo  BLAD: Nie znaleziono folderu grzyby w:
    echo  !BASE!
    echo.
    pause
    exit /b 1
...
robocopy "!SRC!" "!CEL!\grzyby" /E /XF CLAUDE.md *.ps1 *.bat /XD .claude /NP /NFL /NDL
set "RC=%ERRORLEVEL%"
...
if exist "!BASE!Grzyby.html" (
    copy /Y "!BASE!Grzyby.html" "!CEL!\Grzyby.html" >nul
    echo  Grzyby.html ... OK
)
